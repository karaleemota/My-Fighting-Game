...
public class Bomb2 extends Actor
{
    ...
    Fighter opponent;//oppenent is player bomb can inflict damage on
    ...
    public Bomb2(boolean facedRight_)//takes bool to determine which way bomb is facing
    {
    ...
    public Bomb2(boolean facedRight_, int angle_, int velocity_)
    {
        facedRight = facedRight_;
        animateTimer = 0;
        removed = false;
