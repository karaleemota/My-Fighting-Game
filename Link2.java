...
public class Link2 extends Fighter2
{
    ...
    {
        if(Greenfoot.isKeyDown(".") && !carryingBomb)
        {         
    ...
    public void jump(int height)
    {
        ...
        if(Greenfoot.isKeyDown("up") && !carryingBomb && vSpeed > -1 && !hitSpring)//cant jump while carrying bomb
        {
            if(isFacedRight())
            {
                setImage(rightJump1);
    ...
    private void throwBomb()//helps animate link throwing bomb
    {
        if(throwBomb == true)
        {
            ...
            {   
                if(moveCounter3 == 5)
                {
                    getWorld().addObject(new Bomb2(true,10,16), this.getX()+43, this.getY()-41);
            ...
            else//faced left so make bomb facing left
            {
                if(moveCounter3 == 5)
                {
                    getWorld().addObject(new Bomb2(false,10,16), this.getX()-43, this.getY()-41);
    ...
    protected void animate()
    {
        ...
        if (x == 8)
        {
            ...
            && !Greenfoot.isKeyDown("left") && !lightAttackTrue && !throwBomb)
            {
            ...
            && !Greenfoot.isKeyDown("right") && !lightAttackTrue && !throwBomb)
            {
